...
public class LNMExpress {
    ...
    private com.example.moze.Daraja.util.TransactionType Type;
    ...
    public LNMExpress(String businessShortCode, String passKey, com.example.moze.Daraja.util.TransactionType transactionType, String amount, String partyA, String partyB, String phoneNumber, String callBackURL, String accountReference, String transactionDesc) {
        BusinessShortCode = businessShortCode;
        PassKey = passKey;
